CREATE TABLE
  association_patient_chambre (
    ...
    chambre_id int (5) NOT NULL,
    date_entree date NOT NULL,
    date_sortie date NOT NULL
  ) ENGINE = InnoDB DEFAULT CHARSET = latin1;

INSERT INTO
  association_patient_chambre (id_patient, chambre_id, date_entree, date_sortie)
VALUES
...
INSERT INTO
  chambre (id_chambre, capacite, service_id)
VALUES
  (1, 1, 1),
  (2, 1, 1),
  (3, 1, 1),
