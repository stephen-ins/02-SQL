...
INSERT INTO demande (id_demande, personne_id, genre, ville, budget, superficie, categorie) VALUES
...
INSERT INTO logement_agence (id_logementAgence, agence_id, logement_id, frais) VALUES
(1, 257400, 5067, 34250),
(2, 383505, 5067, 30000),
(3, 257400, 5089, 5750),
(4, 692702, 5089, 7623),
...
INSERT INTO logement_personne (id_logementPersonne, personne_id, logement_id) VALUES
(1, 40, 5067),
(2, 41, 5089),
(3, 42, 5091),
(4, 2, 5122),
...
ALTER TABLE demande
  ADD CONSTRAINT demande_ibfk_1 FOREIGN KEY (personne_id) REFERENCES personne (id_personne);

ALTER TABLE logement_agence
  ADD CONSTRAINT logement_agence_ibfk_2 FOREIGN KEY (logement_id) REFERENCES logement (id_logement),
  ADD CONSTRAINT logement_agence_ibfk_1 FOREIGN KEY (agence_id) REFERENCES agence (id_agence);

ALTER TABLE logement_personne
  ADD CONSTRAINT logement_personne_ibfk_2 FOREIGN KEY (personne_id) REFERENCES personne (id_personne),
